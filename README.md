This is pure frontend test project made with Vue CLI3 + Vuetify. It downloads list of data from given URL, allows to validate data item by item or validate all data items in parallel.
